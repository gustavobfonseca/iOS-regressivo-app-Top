...
public class StepDefinitionCartaoTop {
    ...
    public void acessoOMenuTransporte() {
        AppiumDriver driver = AppiumDriverConfig.Instance().driver;
        CartaoTop cartaoTop = new CartaoTop(driver);
        GestosEmulador.clickCoordenada(200,cartaoTop.cartaoTopPelaHome(),"clicar em cartao top na home");    }
    ...
    public void submetoARecargaComumInformandoValorEntreE(String arg0, String arg1) throws InterruptedException {
        ...
        Thread.sleep(4000);
        GestosEmulador.clickCoordenada(106,479);
        try{
            Tela.buscarElementoNaTela("//XCUIElementTypeTextField[@name=\"lg_credit_value_input\"]",3000);
        }catch (Exception e){
            GestosEmulador.clickCoordenada(106,479,"tentando acessar novamente");
        }
...
//        telaHome.buscarFotoDePerfil();
    ...
    public void canceloERetorno() {
        ...
        CartaoTop cartaoTop = new CartaoTop(driver);
        GestosEmulador.clickCoordenada(200,cartaoTop.cartaoTopPelaHome(),"clicar em cartao top na home");        Tela.espera(5000);
